...
<?php if(mysqli_num_rows($result)>0 ) : ?>
    ...
    <?php  while($row = mysqli_fetch_assoc($result) ) : ?>
      <tr>
        ...
        <td><a href="resultatrh.php?accept_user=<?=$row['id'];?> ">Accepter</a> <a href="resultatrh.php?refuse_user=<?=$row['id'];?> ">Refuser</a></td>
        <td><?=$row['decision'];?></td>
      </tr>
    <?php endwhile; ?>
...
<?php endif; ?>
    ...
    <form action="" method="post">
        ...
        <input type="submit" name="déconnecté" value="déconnecté">
    </form>
